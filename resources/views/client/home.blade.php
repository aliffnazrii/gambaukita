            ...
            <section class="photo-packages py-5 bg-light">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">A great option for small events, portraits, or personal
                                        photoshoots.</p>
                                    <ul>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                <img class="card-img-top" src="https://via.placeholder.com/400x300/90ee90"
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                <img class="card-img-top" src="https://via.placeholder.com/400x300/87cefa"
                                    alt="Premium Package">
                                <div class="card-body">
                                    <h4 class="card-title text-center">Premium Package</h4>
                                    <p class="card-text">Perfect for large events like weddings and corporate gatherings.
                                    </p>
                                    <ul>
