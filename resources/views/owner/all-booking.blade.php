...
@section('content')
    ...
    <div class="container">
                        ...
                        @foreach ($bookings as $booking)
                            @if ($booking->progress_status != 'Completed')
                                <tr class="bg-gray-50">
                                    ...
                                    <td class="py-2 px-4 border-b border-gray-300"><a href="{{ $booking->venue }}"
                                            target="_blank" rel="noopener noreferrer">Open Maps</a></td>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0">Completed Bookings</h3>
            </div>
            <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            $('#historyTable').DataTable(); // Initialize DataTables
        });
    </script>
@endsection
